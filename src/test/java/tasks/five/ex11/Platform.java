...
public class Platform {
    ...
    private DesiredCapabilities getIOSDesiredCapabilites() {
        ...
        capabilities.setCapability("app", "/Users/a.krasnov/Library/Mobile Documents/com~apple~CloudDocs/Обучение/Автоматизатор мобильных приложений/JavaAppiumAutomation/apks/Wikipedia.app");
        return capabilities;
    }
