...
public class FirstTest {
    ...
    public void testCancelSearch()
    {
        ...
        for (int i = 0; i < 7; i++)
        {
            Assert.assertTrue(String.format("Java not found in %d line", i), driver.findElement(By.xpath(String.format("//*[@resource-id='org.wikipedia:id/search_results_list']//*[@index='%d']//*[@class='android.widget.LinearLayout']//*[@index='0']", i))).getText().contains("Java"));;
        }
    }
